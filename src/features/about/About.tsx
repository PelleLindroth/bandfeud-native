  ...
  return (
    <BaseView>
      ...
      <View style={styles.textBlock}>
        ...
        <Text style={[TypeScale.h2, styles.headlineBlock]}>Your turn {'>>'}</Text>
        <Text style={TypeScale.p}>
          Type in a band or an artist name beginning with the letter visible under
          the input field.
        </Text>
        <Text style={TypeScale.p}>
        ...
        <Text  style={[TypeScale.h2, styles.headlineBlock]}>App turn {'>>'}</Text>
        <Text style={TypeScale.p}>Next, the app will present a band or an artist. </Text>
        <Text style={TypeScale.p}>
